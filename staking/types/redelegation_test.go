...
func TestUndelegate(t *testing.T) {
	...
	delegation.Unredelegate(epoch1, amount1)
	...
	delegation.Unredelegate(epoch2, amount2)
...
func TestDeleteEntry(t *testing.T) {
	...
	delegation.Unredelegate(epoch3, amount3)
...
func TestUnlockedLastEpochInCommittee(t *testing.T) {
	...
	delegation.Unredelegate(epoch4, amount4)
...
func TestUnlockedFullPeriod(t *testing.T) {
	...
	delegation.Unredelegate(epoch5, amount5)
...
func TestQuickUnlock(t *testing.T) {
	...
	delegation.Unredelegate(epoch7, amount7)
...
func TestUnlockedPremature(t *testing.T) {
	...
	delegation.Unredelegate(epoch6, amount6)
