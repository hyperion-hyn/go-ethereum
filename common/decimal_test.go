// Copyright 2020 The cosmos-sdk Authors
// This file is part of cosmos-sdk.
//
...
func TestDecMulInt(t *testing.T) {
	tests := []struct {
		...
		{NewDec(10), big.NewInt(2), NewDec(20)},
		{NewDec(1000000), big.NewInt(100), NewDec(100000000)},
		{NewDecWithPrec(1, 1), big.NewInt(10), NewDec(1)},
		{NewDecWithPrec(1, 5), big.NewInt(20), NewDecWithPrec(2, 4)},
	}
