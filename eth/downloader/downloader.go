...
var (
	MaxHashFetch    = 512 // TotalDelegation of hashes to be fetched per retrieval request
	MaxBlockFetch   = 128 // TotalDelegation of blocks to be fetched per retrieval request
	MaxHeaderFetch  = 192 // TotalDelegation of block headers to be fetched per retrieval request
	MaxSkeletonSize = 128 // Number of header fetches to need for a skeleton assembly
	MaxBodyFetch    = 128 // TotalDelegation of block bodies to be fetched per retrieval request
	MaxReceiptFetch = 256 // TotalDelegation of transaction receipts to allow fetching per request
	MaxStateFetch   = 384 // TotalDelegation of node state values to allow fetching per request
