...
func (s *PrivateAccountAPI) signTransaction(ctx context.Context, args *SendTxArgs, passwd string) (*types.Transaction, error) {
	...
	return wallet.SignTxWithPassphrase(account, passwd, tx, s.b.ChainConfig().ChainIDFrom(s.b.CurrentHeader().Number))
}
...
func (args *CallArgs) ToMessage(globalGasCap uint64) types.Message {
	...
	msg := types.NewMessageWithTransactionType(addr, args.To, 0, value, gas, gasPrice, data, false, args.TxType) //Atlas
	return msg
}
...
func RPCMarshalHeader(head *types.Header) map[string]interface{} {
	return map[string]interface{}{
		...
		"lastCommits": hexutil.Bytes(head.LastCommits),
		"slashes":     hexutil.Bytes(head.Slashes),
	}
}
...
func (s *PublicTransactionPoolAPI) sign(addr common.Address, tx *types.Transaction) (*types.Transaction, error) {
	...
	return wallet.SignTx(account, tx, s.b.ChainConfig().ChainIDFrom(s.b.CurrentHeader().Number))
}
...
func (s *PublicTransactionPoolAPI) SendTransaction(ctx context.Context, args SendTxArgs) (common.Hash, error) {
	...
	signed, err := wallet.SignTx(account, tx, s.b.ChainConfig().ChainIDFrom(s.b.CurrentHeader().Number))
	if err != nil {
		return common.Hash{}, err
	}
	return SubmitTransaction(ctx, s.b, signed)
