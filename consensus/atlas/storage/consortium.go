...
// &wrapper.tmplStruct{T:0x4, Name:"Slice_a38c5e05aa47", Fields:[]*wrapper.tmplField{(*wrapper.tmplField)(0xc00055e7e0)}, Type:"[]*Validator_t", SolKind:abi.Type{Elem:(*abi.Type)(0xc000530fc0), Kind:0x17, Type:(*reflect.rtype)(0xc00050b6c0), Size:0, T:0x4, NumberOfBytes:0x20, StringKind:"t_array(t_struct(Validator_t)6_storage)dyn_storage", TupleRawName:"", TupleElems:[]*abi.Type(nil), TupleRawNames:[]string(nil)}}
// "[]*struct { PubKey []uint8 \"json:\\\"PubKey\\\" storage:\\\"slot=0,offset=0\\\"\"; Account common.Address \"json:\\\"Account\\\" storage:\\\"slot=1,offset=0\\\"\" }"
...
func (s *Storage_Slice_a38c5e05aa47) Resize(length uint64) {
...
func (s *Storage_Slice_a38c5e05aa47) Get(index int) *Storage_Validator_t {
	// Value: &wrapper.tmplField{Type:"Validator_t", ElemType:"", Name:"", SolKind:abi.Type{Elem:(*abi.Type)(nil), Kind:0x16, Type:(*reflect.rtype)(0xc00050b680), Size:0, T:0x6, NumberOfBytes:0x40, StringKind:"t_struct(Validator_t)6_storage", TupleRawName:"Validator_t", TupleElems:[]*abi.Type{(*abi.Type)(0xc000531050), (*abi.Type)(0xc000531170)}, TupleRawNames:[]string{"PubKey", "Account"}}, Tag:"", Slot:<nil>, Offset:0}
	length := s.Length()
	if length < index {
...
// &wrapper.tmplStruct{T:0x6, Name:"Committee_t", Fields:[]*wrapper.tmplField{(*wrapper.tmplField)(0xc00055e8c0)}, Type:"", SolKind:abi.Type{Elem:(*abi.Type)(nil), Kind:0x0, Type:reflect.Type(nil), Size:0, T:0x0, NumberOfBytes:0x0, StringKind:"", TupleRawName:"", TupleElems:[]*abi.Type(nil), TupleRawNames:[]string(nil)}}
...
// &wrapper.tmplStruct{T:0x6, Name:"Global_t", Fields:[]*wrapper.tmplField{(*wrapper.tmplField)(0xc00055e9a0)}, Type:"", SolKind:abi.Type{Elem:(*abi.Type)(nil), Kind:0x0, Type:reflect.Type(nil), Size:0, T:0x0, NumberOfBytes:0x0, StringKind:"", TupleRawName:"", TupleElems:[]*abi.Type(nil), TupleRawNames:[]string(nil)}}
...
// &wrapper.tmplStruct{T:0x6, Name:"Validator_t", Fields:[]*wrapper.tmplField{(*wrapper.tmplField)(0xc00055e620), (*wrapper.tmplField)(0xc00055e700)}, Type:"", SolKind:abi.Type{Elem:(*abi.Type)(nil), Kind:0x0, Type:reflect.Type(nil), Size:0, T:0x0, NumberOfBytes:0x0, StringKind:"", TupleRawName:"", TupleElems:[]*abi.Type(nil), TupleRawNames:[]string(nil)}}
type Validator_t struct {
	PubKey  Bytes   `json:"PubKey" storage:"slot=0,offset=0"`
	Account Address `json:"Account" storage:"slot=1,offset=0"`
}
...
func (s *Storage_Committee_t) Members() *Storage_Slice_a38c5e05aa47 {
	// Field: &wrapper.tmplField{Type:"Slice_a38c5e05aa47", ElemType:"Slice_a38c5e05aa47", Name:"Members", SolKind:abi.Type{Elem:(*abi.Type)(0xc000530fc0), Kind:0x17, Type:(*reflect.rtype)(0xc00050b6c0), Size:0, T:0x4, NumberOfBytes:0x20, StringKind:"t_array(t_struct(Validator_t)6_storage)dyn_storage", TupleRawName:"", TupleElems:[]*abi.Type(nil), TupleRawNames:[]string(nil)}, Tag:"json:\"members\" storage:\"slot=0,offset=0\"", Slot:0, Offset:0}
	var slot *big.Int
...
func (s *Storage_Global_t) Committee() *Storage_Committee_t {
	// Field: &wrapper.tmplField{Type:"Committee_t", ElemType:"Committee_t", Name:"Committee", SolKind:abi.Type{Elem:(*abi.Type)(nil), Kind:0x19, Type:(*reflect.rtype)(0xc00050f020), Size:0, T:0x6, NumberOfBytes:0x20, StringKind:"t_struct(Committee_t)10_storage", TupleRawName:"Committee_t", TupleElems:[]*abi.Type{(*abi.Type)(0xc000531440)}, TupleRawNames:[]string{"members"}}, Tag:"json:\"committee\" storage:\"slot=0,offset=0\"", Slot:0, Offset:0}
	var slot *big.Int
	slot, _ = big.NewInt(0).SetString("0", 10)
	offset := 0
...
func (s *Storage_Validator_t) PubKey() *Storage_Bytes {
	// Field: &wrapper.tmplField{Type:"Bytes", ElemType:"Bytes", Name:"PubKey", SolKind:abi.Type{Elem:(*abi.Type)(nil), Kind:0x17, Type:(*reflect.rtype)(0x4795bc0), Size:0, T:0x9, NumberOfBytes:0x20, StringKind:"t_bytes_storage", TupleRawName:"", TupleElems:[]*abi.Type(nil), TupleRawNames:[]string(nil)}, Tag:"json:\"PubKey\" storage:\"slot=0,offset=0\"", Slot:0, Offset:0}
	var slot *big.Int
	slot, _ = big.NewInt(0).SetString("0", 10)
	offset := 0
...
func (s *Storage_Validator_t) Account() *Storage_Address {
	// Field: &wrapper.tmplField{Type:"Address", ElemType:"Address", Name:"Account", SolKind:abi.Type{Elem:(*abi.Type)(nil), Kind:0x11, Type:(*reflect.rtype)(0x4862ec0), Size:20, T:0x7, NumberOfBytes:0x14, StringKind:"t_address", TupleRawName:"", TupleElems:[]*abi.Type(nil), TupleRawNames:[]string(nil)}, Tag:"json:\"Account\" storage:\"slot=1,offset=0\"", Slot:1, Offset:0}
	var slot *big.Int
